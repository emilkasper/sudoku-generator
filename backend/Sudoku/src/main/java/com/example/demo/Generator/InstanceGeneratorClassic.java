...
import com.example.demo.Solver.SATSolver;
import com.example.demo.Solver.SATSolverDPLL;
import com.example.demo.Solver.SATSolverResult;
 ...
 */
public class InstanceGeneratorClassic implements com.example.demo.Generator.InstanceGenerator {

  private final SudokuConfig config;
  private int numRemove = 40;

  public InstanceGeneratorClassic() {
    this.config = new SudokuConfigClassic();
  }

  public InstanceGeneratorClassic(int numRemove) {
  ...
  public int[][][] generateInstance() {
    ...
    SudokuRandomizer.addRandomHints(clauses);
  ...
  /**
   * Generates a classic Sudoku puzzle-solution pair.
   * The puzzle is generated by removing a fixed number of cells from the solved instance.
   *
   * @return a classic Sudoku puzzle-solution pair
   */
  @Override
  public int[][][][] generatePuzzlePair() {
    int[][][] solved = generateInstance();
    int[][][] puzzle = generatePuzzleFromSolved(solved, numRemove);
    return new int[][][][] { puzzle, solved };
  }
